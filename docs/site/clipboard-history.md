...
::source{path="packages/zod-crud/src/clipboard/json-clipboard.ts" lines="69-96" title="copy APIs"}

## cut과 cutMany

`cut`은 root를 대상으로 할 수 없습니다. 삭제가 성공한 뒤에만 clipboard가 갱신되므로, 스키마상 삭제가 불가능한 노드를 잘랐다고 해서 clipboard가 오염되지 않습니다.

::source{path="packages/zod-crud/src/clipboard/json-clipboard.ts" lines="98-135" title="cut APIs"}
...
::source{path="packages/zod-crud/src/clipboard/json-clipboard.ts" lines="137-167" title="paste APIs"}
...
::source{path="packages/zod-crud/src/clipboard/json-paste.ts" lines="19-77" title="buildPastePlans"}
...
::source{path="packages/zod-crud/src/clipboard/json-clipboard.ts" lines="202-239" title="commitFirstValidPaste"}
...
::source{path="packages/zod-crud/src/history/json-history.ts" lines="46-114" title="history commit / undo / redo"}

## clipboard를 건드리지 않는 move

Move는 cut/paste의 조합이 아니라 별도 command입니다. 이 차이 때문에 clipboard state와 history transaction의 의미가 분리됩니다.

::source{path="packages/zod-crud/src/clipboard/json-move.ts" lines="261-335" title="moveToArray"}
