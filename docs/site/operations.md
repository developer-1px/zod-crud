...
::source{path="packages/zod-crud/src/mutate/mutations.ts" lines="62-84" title="create"}

::source{path="packages/zod-crud/src/mutate/mutations.ts" lines="126-155" title="appendChild"}
...
::source{path="packages/zod-crud/src/mutate/mutations.ts" lines="86-124" title="sibling insertion"}

## update

`update(nodeId, value)`는 먼저 해당 node path의 schema로 값을 검증한 뒤 subtree를 교체합니다. 교체 후에는 전체 document 검증과 exact match 검증을 다시 거칩니다.

::source{path="packages/zod-crud/src/mutate/mutations.ts" lines="157-174" title="update"}
...
::source{path="packages/zod-crud/src/mutate/mutations.ts" lines="176-205" title="rename"}
...
::source{path="packages/zod-crud/src/mutate/mutations.ts" lines="207-236" title="delete"}
...
::source{path="packages/zod-crud/src/mutate/move.ts" lines="41-75" title="move API"}

::source{path="packages/zod-crud/src/mutate/move.ts" lines="106-157" title="move planning"}
