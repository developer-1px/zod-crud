...
::source{path="packages/zod-crud/src/editor/json-crud.ts" lines="37-79" title="JsonCrud API"}
...
::source{path="packages/zod-crud/src/editor/json-crud.ts" lines="169-188" title="read helpers"}
...
::source{path="packages/zod-crud/src/editor/json-selection.ts" lines="18-38" title="normalizeSelection"}
...
::source{path="packages/zod-crud/src/editor/json-mutations.ts" lines="62-84" title="create"}

::source{path="packages/zod-crud/src/editor/json-mutations.ts" lines="126-155" title="appendChild"}
...
::source{path="packages/zod-crud/src/editor/json-mutations.ts" lines="86-124" title="sibling insertion"}

## update

`update(nodeId, value)`는 먼저 해당 node path의 schema로 값을 검증한 뒤 subtree를 교체합니다. 교체 후에는 전체 document 검증과 exact match 검증을 다시 거칩니다.

::source{path="packages/zod-crud/src/editor/json-mutations.ts" lines="157-174" title="update"}
...
::source{path="packages/zod-crud/src/editor/json-mutations.ts" lines="176-205" title="rename"}
...
::source{path="packages/zod-crud/src/editor/json-mutations.ts" lines="207-236" title="delete"}
...
::source{path="packages/zod-crud/src/editor/json-move.ts" lines="41-75" title="move API"}

::source{path="packages/zod-crud/src/editor/json-move.ts" lines="106-157" title="move planning"}
...
::source{path="packages/zod-crud/src/editor/json-crud.ts" lines="198-235" title="can* preflight"}

## subscribe

`subscribe`는 성공 commit 이후에 호출되는 listener를 등록합니다. 반환값은 unsubscribe 함수입니다. React에서는 `useEffect`에서 등록하고 cleanup으로 해제하면 됩니다.

::source{path="packages/zod-crud/src/editor/json-crud.ts" lines="320-330" title="subscribe"}
