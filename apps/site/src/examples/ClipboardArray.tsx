  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap gap-1.5 text-xs">
        <button onClick={onCopy} disabled={selected === null} className="rounded border border-stone-300 bg-white px-2 py-1 disabled:opacity-50">copy → end</button>
        <button onClick={onCut} disabled={selected === null} className="rounded border border-stone-300 bg-white px-2 py-1 disabled:opacity-50">cut → end</button>
