...
export const repoCatalog = {
  ...
  "labExtensions": [
    ...
    {
      "path": "labs/extensions/batch-set",
      "name": "@zod-crud/batch-set",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      "description": "Lab batch-set (set a field across selected items) extension functions for zod-crud documents.",
      "license": "MIT",
      "summary": "Lab batch-set extension for `zod-crud` documents.",
      "guidance": {
    ...
    {
      "path": "labs/extensions/clear-values",
      "name": "@zod-crud/clear-values",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      "description": "Lab clear-values (reset fields to schema-derived empties) extension functions for zod-crud documents.",
      "license": "MIT",
      "summary": "Lab clear-values extension for `zod-crud` documents.",
      "guidance": {
    ...
    },
    {
      ...
      "publicExports": [
        ...
        "CollectionSortChangeResult",
        "CollectionSortCompare",
        "CollectionSortError",
        "CollectionSortErrorCode",
        "CollectionSortItem",
        "CollectionSortResult",
        "canReverse",
        "canSort",
    ...
    {
      "path": "labs/extensions/computed-fields",
      "name": "@zod-crud/computed-fields",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
    ...
    {
      "path": "labs/extensions/convert-node-kind",
      "name": "@zod-crud/convert-node-kind",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      ...
      "publicExports": [
        ...
        "NodeKindConversionErrorCode",
        "NodeKindConversionFactoryInput",
        "NodeKindConversionInput",
    ...
    {
      "path": "labs/extensions/pad",
      "name": "@zod-crud/pad",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      "description": "Lab pad (pad a string to a minimum length) extension functions for zod-crud documents.",
      "license": "MIT",
      "summary": "Lab pad extension for `zod-crud` documents.",
      "guidance": {
    ...
    {
      "path": "labs/extensions/reindex",
      "name": "@zod-crud/reindex",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      "description": "Lab reindex (sync an order field to array position) extension functions for zod-crud documents.",
      "license": "MIT",
      "summary": "Lab reindex extension for `zod-crud` documents.",
      "guidance": {
    ...
    {
      "path": "labs/extensions/swap",
      "name": "@zod-crud/swap",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      "description": "Lab swap (exchange two array items) extension functions for zod-crud documents.",
      "license": "MIT",
      "summary": "Lab swap extension for `zod-crud` documents.",
      "guidance": {
    ...
    {
      "path": "labs/extensions/truncate",
      "name": "@zod-crud/truncate",
      "status": "lab-extension",
      "private": true,
      "publishable": false,
      "version": "0.1.0",
      "description": "Lab truncate (cap a string to a max length) extension functions for zod-crud documents.",
      "license": "MIT",
      "summary": "Lab truncate extension for `zod-crud` documents.",
      "guidance": {
