# @zod-crud/field-draft

Lab field draft extension for `zod-crud` documents.
...
```ts
import { createFieldDraft } from "@zod-crud/field-draft";
...
- Hold per-field draft input outside document state.
...
The public facade is enough for field drafts. The extension keeps temporary
