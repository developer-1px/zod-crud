# @zod-crud/document-outline

Headless document outline helpers for `zod-crud` documents.

Lab status: private prototype. Not an official package.

```ts
import { createDocumentOutline } from "@zod-crud/document-outline";

const outline = createDocumentOutline(doc, "", { maxDepth: 2 });
