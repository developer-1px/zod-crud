...
const byRank: CollectionSortCompare<CardValue> = (left, right) => left.value.rank - right.value.rank;
const byTitle: CollectionSortCompare<CardValue> = (left, right) =>
...
describe("@zod-crud/collection-sort", () => {
