# @zod-crud/pointer-bookmarks

Headless Pointer bookmark tracking helpers for `zod-crud` documents.

Lab status: private prototype. Not an official package.

```ts
import { createPointerBookmarks } from "@zod-crud/pointer-bookmarks";

const bookmarks = createPointerBookmarks(doc, {
