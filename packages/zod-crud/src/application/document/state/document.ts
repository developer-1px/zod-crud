...
import type { DocumentHistoryEntry } from "../history/types.js";
import type { JSONChangeMetadata, JSONStateOps } from "./types.js";
...
export interface DocumentHistoryRuntimeState {
  ...
  isRestoring: boolean;
  activeHistoryMetadata: import("./types.js").HistoryTransactionOptions | undefined;
