...
} from "../../../domain/schema/patch.js";
import {
  primaryPointer,
  selectedSource,
} from "../../../domain/selection/read.js";
import { resolveSelectionScope } from "../../../domain/selection/order.js";
import { resolveSelectionCursor } from "../../../domain/selection/reducer.js";
import {
  EMPTY_SELECTION,
...
import { copy, type ClipboardSource } from "../../../domain/copy.js";
