...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { applyOperation, applyPatch, createClipboard, createJSONDocument, createSelection, parsePointer, tryParsePointer, buildPointer, parentPointer, lastSegment, lastSegmentIndex, appendSegment, withLastSegment, find, move, replace } from "zod-crud";',
  ...
  await writeFile(
    ...
    [
      ...
      'import type { ApplyResult, ClipboardSource, ClipboardState, CopyError, CopyOk, CopyResult, CreateClipboardOptions, CreateSelectionOptions, CutOk, DuplicateOk, DuplicateOpts, ErrorCode, FindError, FindOk, HeadlessSelectionState, JSONChangeListener, JSONLoadOptions, JSONOps, JSONResult, MoveError, MoveOk, MoveResult, PasteDuMismatch, PasteMode, PasteOk, PasteOptions, PointerOf, RekeyContext, RekeyOptions, RekeyStrategy, SelectionAction, SelectionChangeListener, SelectionMode, SelectionRangeInput, SelectionSnap, SelectionState, SelectionType, UseJSONOptions, UseSelectionOptions, ValueAt } from "zod-crud";',
      'const schema = z.object({ name: z.string() });',
      'type PublicRootTypes = [ApplyResult<typeof schema>, ClipboardSource, ClipboardState<z.output<typeof schema>>, CopyError, CopyOk, CopyResult, CreateClipboardOptions<typeof schema>, CreateSelectionOptions, CutOk<z.output<typeof schema>>, DuplicateOk<z.output<typeof schema>>, DuplicateOpts, ErrorCode, FindError, FindOk, HeadlessSelectionState<z.output<typeof schema>>, JSONChangeListener, JSONLoadOptions, JSONOps<z.output<typeof schema>>, JSONResult, MoveError, MoveOk<z.output<typeof schema>>, MoveResult<z.output<typeof schema>>, PasteDuMismatch, PasteMode, PasteOk<z.output<typeof schema>>, PasteOptions, PointerOf<z.output<typeof schema>>, RekeyContext, RekeyOptions, RekeyStrategy, SelectionAction, SelectionChangeListener, SelectionMode, SelectionRangeInput, SelectionSnap, SelectionState<z.output<typeof schema>>, SelectionType, UseJSONOptions, UseSelectionOptions, ValueAt<z.output<typeof schema>, "/name">];',
