...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, applyOperation, applyPatch, createClipboard, createDraft, createJSON, createRecorder, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, parsePointer, tryParsePointer, buildPointer, parentPointer, lastSegment, lastSegmentIndex, appendSegment, withLastSegment, find, replace, toJSONSchema, fromJSONSchema } from "zod-crud";',
  ...
  await writeFile(
    ...
    [
      ...
      'import { useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder } from "zod-crud/react";',
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { type DraftFieldState, type DraftState, type JSONDocument, type JSONOps, type RecorderApi, type SelectionState, type UseJSONDocumentOptions, type UseJSONOptions, type UseSelectionOptions, useDraft, useField, useJSON, useJSONDocument, useJSONSlice, useRecorder, useSelection } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
