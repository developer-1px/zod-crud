...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, createClipboard, createDebugLog, createDraft, createRecorder, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder, replayRecording, useDebugLog } from "zod-crud/react";',
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { JSONCrudError, createClipboard, createDebugLog, createDraft, createRecorder, createSelection, replayRecording, type ClipboardState, type CreateClipboardOptions, type CreateDebugLogOptions, type CreateDraftOptions, type CreateRecorderOptions, type CreateSelectionOptions, type DebugEvent, type DebugLog, type DebugLogApi, type DebugLogger, type DraftChangeListener, type DraftDocument, type DraftFieldState, type DraftState, type HeadlessDebugLogApi, type HeadlessDraftState, type HeadlessRecorderApi, type HeadlessSelectionState, type HistoryStack, type JSONDocument, type JSONOps, type RecordedStep, type RecorderApi, type Recording, type ReplayDocumentTarget, type ReplayOptions, type ReplaySelectionTarget, type ReplayTarget, type SelectionChangeListener, type SelectionRangeInput, type SelectionState, type UseSelectionOptions, useDebugLog, useDraft, useField, useJSON, useJSONDocument, useJSONSlice, useRecorder, useSelection } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
