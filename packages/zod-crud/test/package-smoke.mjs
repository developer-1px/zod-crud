...
try {
  ...
  await writeFile(
    ...
    [
      'import { useJSONDocument, useJSON, useSelection, useDraft, useField, useRecorder, replayRecording, useDebugLog } from "zod-crud/react";',
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { JSONCrudError, type DebugLog, type DebugLogApi, type DebugLogger, type DraftFieldState, type DraftState, type JSONDocument, type JSONOps, type RecordedStep, type RecorderApi, type Recording, type ReplayOptions, type SelectionState, useDebugLog, useDraft, useField, useJSON, useJSONDocument } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
