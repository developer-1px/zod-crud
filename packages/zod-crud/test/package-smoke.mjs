...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, applyOperation, applyPatch, createCan, createCheck, createClipboard, createCommands, createDebugLog, createDraft, createRead, createRecorder, createSchema, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, parsePointer, tryParsePointer, buildPointer, parentPointer, lastSegment, lastSegmentIndex, appendSegment, withLastSegment, find, replace, buildPatchRequest, parsePatchResponse, withIfMatch, parseMergePatch, applyMergePatch, JSON_PATCH_MIME, MERGE_PATCH_MIME, toJSONSchema, fromJSONSchema } from "zod-crud";',
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, createCan, createCheck, createClipboard, createCommands, createDebugLog, createDraft, createRead, createRecorder, createSchema, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder, replayRecording, useDebugLog } from "zod-crud/react";',
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { JSONCrudError, createCan, createCheck, createClipboard, createCommands, createDebugLog, createDraft, createRead, createRecorder, createSchema, createSelection, replayRecording, type Can, type ClipboardState, type CommandSelectionState, type Commands, type CreateCanOptions, type CreateCheckOptions, type CreateClipboardOptions, type CreateCommandsOptions, type CreateDebugLogOptions, type CreateDraftOptions, type CreateReadOptions, type CreateRecorderOptions, type CreateSchemaOptions, type CreateSelectionOptions, type DebugEvent, type DebugLog, type DebugLogApi, type DebugLogger, type DraftChangeListener, type DraftDocument, type DraftFieldState, type DraftState, type HeadlessDebugLogApi, type HeadlessDraftState, type HeadlessRecorderApi, type HeadlessSelectionState, type HistoryStack, type JSONDocument, type JSONOps, type ReadFacade, type RecordedStep, type RecorderApi, type Recording, type ReplaceCommandResult, type ReplayDocumentTarget, type ReplayOptions, type ReplaySelectionTarget, type ReplayTarget, type SchemaState, type SelectionChangeListener, type SelectionRangeInput, type SelectionState, type UseSelectionOptions, useDebugLog, useDraft, useField, useJSON, useJSONDocument, useJSONSlice, useRecorder, useSelection } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
