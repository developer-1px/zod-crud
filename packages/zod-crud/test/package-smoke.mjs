...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import type { ApplyResult, ErrorCode, JSONOps, JSONResult, PointerOf, SelectionAction, SelectionMode, SelectionRangeInput, SelectionSnap, SelectionState, SelectionType, ValueAt } from "zod-crud";',
      'const schema = z.object({ name: z.string() });',
      'type PublicRootTypes = [ApplyResult<typeof schema>, ErrorCode, JSONOps<z.output<typeof schema>>, JSONResult, PointerOf<z.output<typeof schema>>, SelectionAction, SelectionMode, SelectionRangeInput, SelectionSnap, SelectionState<z.output<typeof schema>>, SelectionType, ValueAt<z.output<typeof schema>, "/name">];',
