...
try {
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { JSONCrudError, type DebugLog, type DebugLogApi, type DebugLogger, type JSONDocument, type JSONOps, type RecordedStep, type RecorderApi, type Recording, type ReplayOptions, type SelectionState, useDebugLog, useJSON, useJSONDocument } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
