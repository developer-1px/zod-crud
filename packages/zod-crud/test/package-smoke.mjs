...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { createDebugLog, createDraft, createRecorder, createSelection, useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder, replayRecording, useDebugLog } from "zod-crud/react";',
