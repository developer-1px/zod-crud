...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, applyOperation, applyPatch, createClipboard, createJSON, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, parsePointer, tryParsePointer, buildPointer, parentPointer, lastSegment, lastSegmentIndex, appendSegment, withLastSegment, find, replace, toJSONSchema, fromJSONSchema } from "zod-crud";',
