...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import type { HistoryTransactionOptions, JSONCapabilityResult, JSONChangeMetadata, JSONDocument, JSONDocumentCommitOptions, JSONDocumentDuplicateOptions, JSONDocumentDuplicateResult, JSONDocumentHistory, JSONDocumentPasteOptions, JSONDocumentPasteTarget, JSONPatchInput, JSONPoint, JSONResult, UseJSONDocumentOptions } from "zod-crud";',
      'import type { ClipboardCopyOptions, ClipboardCutOk, ClipboardCutOptions, ClipboardCutResult, ClipboardEmpty, ClipboardMutationOk, ClipboardPasteResult, ClipboardReadOk, ClipboardReadOptions, ClipboardReadResult, ClipboardState, ClipboardWriteOptions, ClipboardSource, CopyError, CopyOk, CutError, CutOk, DuplicateError, DuplicateOk, PasteDuMismatch, PasteError, PasteOptions, PasteTarget } from "zod-crud";',
      'import type { EntriesResult, EntryKind, QueryResult, ReadEntry, ReadResult, SchemaDescription, SchemaDescriptionResult, SchemaErrorCode, SchemaErrorResult, SchemaKind, SchemaKindResult, SchemaPathMode, SchemaQueryResult, SchemaState } from "zod-crud";',
      'import type { DeleteSelectionTextResult, JSONPointObject, OrderedSelectionRange, OrderedSelectionRangeEntry, ReplaceSelectionTextResult, SelectionAction, SelectionAffinity, SelectionContext, SelectionCursorDirection, SelectionCursorErrorCode, SelectionCursorOptions, SelectionCursorResult, SelectionCursorTarget, SelectionDirection, SelectionEdge, SelectionMode, SelectionOrderErrorCode, SelectionOrderOptions, SelectionPointOrderResult, SelectionPointerSpan, SelectionPointerSpansResult, SelectionRange, SelectionRangeInput, SelectionRangeOrderResult, SelectionRangesOrderResult, SelectionScopeErrorCode, SelectionScopeOptions, SelectionScopeResult, SelectionScopeTarget, SelectionSource, SelectionSpanOptions, SelectionSnap, SelectionState, SelectionTextDeleteDirection, SelectionTextDeleteOptions, SelectionTextEdit, SelectionTextEditErrorCode, SelectionTextEditOptions, SelectionTextEditsResult, SelectionType, UseSelectionOptions } from "zod-crud";',
      'const schema = z.object({ name: z.string() });',
      'type Row = z.output<typeof schema>;',
      'type PublicRootTypes = [HistoryTransactionOptions, JSONCapabilityResult, JSONChangeMetadata, JSONDocument<Row>, JSONDocumentCommitOptions, JSONDocumentDuplicateOptions, JSONDocumentDuplicateResult<Row>, JSONDocumentHistory, JSONDocumentPasteOptions, JSONDocumentPasteTarget, JSONPatchInput, JSONPatchOperation, JSONPoint, JSONResult, Pointer, UseJSONDocumentOptions, ClipboardCopyOptions, ClipboardCutOk<Row>, ClipboardCutOptions, ClipboardCutResult<Row>, ClipboardEmpty, ClipboardMutationOk<Row>, ClipboardPasteResult<Row>, ClipboardReadOk, ClipboardReadOptions, ClipboardReadResult, ClipboardState<Row>, ClipboardWriteOptions, ClipboardSource, CopyError, CopyOk, CutError, CutOk<Row>, DuplicateError, DuplicateOk<Row>, PasteDuMismatch, PasteError, PasteOptions, PasteTarget, EntriesResult, EntryKind, QueryResult, ReadEntry, ReadResult, SchemaDescription, SchemaDescriptionResult, SchemaErrorCode, SchemaErrorResult, SchemaKind, SchemaKindResult, SchemaPathMode, SchemaQueryResult, SchemaState, DeleteSelectionTextResult, JSONPointObject, OrderedSelectionRange, OrderedSelectionRangeEntry, ReplaceSelectionTextResult, SelectionAction, SelectionAffinity, SelectionContext, SelectionCursorDirection, SelectionCursorErrorCode, SelectionCursorOptions, SelectionCursorResult, SelectionCursorTarget, SelectionDirection, SelectionEdge, SelectionMode, SelectionOrderErrorCode, SelectionOrderOptions, SelectionPointOrderResult, SelectionPointerSpan, SelectionPointerSpansResult, SelectionRange, SelectionRangeInput, SelectionRangeOrderResult, SelectionRangesOrderResult, SelectionScopeErrorCode, SelectionScopeOptions, SelectionScopeResult, SelectionScopeTarget, SelectionSource, SelectionSpanOptions, SelectionSnap, SelectionState, SelectionTextDeleteDirection, SelectionTextDeleteOptions, SelectionTextEdit, SelectionTextEditErrorCode, SelectionTextEditOptions, SelectionTextEditsResult, SelectionType, UseSelectionOptions];',
