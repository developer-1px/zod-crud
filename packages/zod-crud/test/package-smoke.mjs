...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { createRecorder, createSelection, useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder, replayRecording, useDebugLog } from "zod-crud/react";',
