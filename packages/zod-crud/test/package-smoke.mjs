...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import type { ApplyResult, ErrorCode, JSONOps, JSONPoint, JSONResult, PointerOf, SelectionAction, SelectionRange, SelectionSnap, SelectionState, ValueAt } from "zod-crud";',
      'const schema = z.object({ name: z.string() });',
      'type PublicRootTypes = [ApplyResult<typeof schema>, ErrorCode, JSONOps<z.output<typeof schema>>, JSONPoint, JSONResult, PointerOf<z.output<typeof schema>>, SelectionAction, SelectionRange, SelectionSnap, SelectionState<z.output<typeof schema>>, ValueAt<z.output<typeof schema>, "/name">];',
