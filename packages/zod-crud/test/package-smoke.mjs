...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder, useDebugLog } from "zod-crud/react";',
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { type DebugLogApi, type DraftFieldState, type DraftState, type JSONDocument, type JSONOps, type RecorderApi, type SelectionState, type UseJSONDocumentOptions, type UseJSONOptions, type UseSelectionOptions, useDebugLog, useDraft, useField, useJSON, useJSONDocument, useJSONSlice, useRecorder, useSelection } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
      ...
      'useRecorder satisfies (ops: Ops) => RecorderApi<Value>;',
      'useDebugLog satisfies (ops: Ops, selection?: SelectionState<Value>) => DebugLogApi<Value>;',
      'useDraft satisfies (doc: Doc) => DraftState<Value>;',
      ...
      'const _draft = null as unknown as DraftState<Value>;',
      'const _draftField = null as unknown as DraftFieldState<string>;',
      'const _recorder = null as unknown as RecorderApi<Value>;',
      'const _debugLog = null as unknown as DebugLogApi<Value>;',
      ...
      '_recorder.steps satisfies readonly import("zod-crud").RecordedStep[];',
      '_debugLog.events satisfies readonly import("zod-crud").DebugEvent[];',
    ].join("\n"),
  );
  await writeFile(
