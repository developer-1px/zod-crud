...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, applyOperation, applyPatch, createCan, createCheck, createClipboard, createCommands, createDebugLog, createDraft, createJSON, createRead, createRecorder, createSchema, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, parsePointer, tryParsePointer, buildPointer, parentPointer, lastSegment, lastSegmentIndex, appendSegment, withLastSegment, find, replace, buildPatchRequest, parsePatchResponse, withIfMatch, parseMergePatch, applyMergePatch, JSON_PATCH_MIME, MERGE_PATCH_MIME, toJSONSchema, fromJSONSchema } from "zod-crud";',
      ...
      'if (typeof createCan !== "function") throw new Error("createCan export failed");',
      'if (typeof createCheck !== "function") throw new Error("createCheck export failed");',
      'if (typeof createClipboard !== "function") throw new Error("createClipboard export failed");',
      'if (typeof createCommands !== "function") throw new Error("createCommands export failed");',
      'if (typeof createDebugLog !== "function") throw new Error("createDebugLog export failed");',
      'if (typeof createDraft !== "function") throw new Error("createDraft export failed");',
      'if (typeof createJSON !== "function") throw new Error("createJSON export failed");',
      'if (typeof createRead !== "function") throw new Error("createRead export failed");',
      'if (typeof createRecorder !== "function") throw new Error("createRecorder export failed");',
      'if (typeof createSchema !== "function") throw new Error("createSchema export failed");',
      'if (typeof createSelection !== "function") throw new Error("createSelection export failed");',
      'if (!createRead({ schema, getState: () => initial }).at("/name").ok) throw new Error("createRead runtime failed");',
      'if (!createSchema({ schema }).kind("/name").ok) throw new Error("createSchema runtime failed");',
      'const jsonState = createJSON(schema, initial);',
      'if (!jsonState.ops.replace("/name", "json").ok || jsonState.value.name !== "json") throw new Error("createJSON runtime failed");',
      ...
      'if (historyPopped?.entry.id !== "entry") throw new Error("historyBack export failed");',
      'const historyRestored = historyPopped ? historyForward(historyPopped.next) : null;',
  ...
  await writeFile(
    ...
    [
      ...
      'import type { ApplyResult, Can, ClipboardItemMap, ClipboardItemOptions, ClipboardSource, ClipboardState, CommandSelectionState, Commands, CopyError, CopyOk, CopyResult, CreateCanOptions, CreateCheckOptions, CreateClipboardOptions, CreateCommandsOptions, CreateDebugLogOptions, CreateDraftOptions, CreateJSONOptions, CreateReadOptions, CreateRecorderOptions, CreateSchemaOptions, CreateSelectionOptions, CutOk, DebugEvent, DebugLog, DebugLogApi, DebugLogger, DraftChangeListener, DraftDocument, DraftFieldState, DraftState, DuplicateOk, DuplicateOpts, ErrorCode, FindError, FindOk, HeadlessDebugLogApi, HeadlessDraftState, HeadlessJSONState, HeadlessRecorderApi, HeadlessSelectionState, HistoryStack, JSONChangeListener, JSONLoadOptions, JSONOps, JSONResult, JSONState, MoveError, MoveOk, MoveResult, PasteDuMismatch, PasteMode, PasteOk, PasteOptions, PointerOf, ReadFacade, RecordedStep, RecorderApi, Recording, RedoResult, RekeyContext, RekeyOptions, RekeyStrategy, ReplaceCommandResult, ReplayDocumentTarget, ReplayOptions, ReplaySelectionTarget, ReplayTarget, SchemaState, SelectionAction, SelectionChangeListener, SelectionMode, SelectionRangeInput, SelectionSnap, SelectionState, SelectionType, UndoEntry, UndoNoop, UndoResult, UseJSONOptions, UseSelectionOptions, ValueAt } from "zod-crud";',
      'const schema = z.object({ name: z.string() });',
      'type PublicRootTypes = [ApplyResult<typeof schema>, Can<z.output<typeof schema>>, ClipboardItemMap, ClipboardItemOptions, ClipboardSource, ClipboardState<z.output<typeof schema>>, CommandSelectionState, Commands<z.output<typeof schema>>, CopyError, CopyOk, CopyResult, CreateCanOptions<typeof schema>, CreateCheckOptions<typeof schema>, CreateClipboardOptions<typeof schema>, CreateCommandsOptions<typeof schema>, CreateDebugLogOptions, CreateDraftOptions, CreateJSONOptions, CreateReadOptions<typeof schema>, CreateRecorderOptions, CreateSchemaOptions<typeof schema>, CreateSelectionOptions, CutOk<z.output<typeof schema>>, DebugEvent, DebugLog<z.output<typeof schema>>, DebugLogApi<z.output<typeof schema>>, DebugLogger, DraftChangeListener<z.output<typeof schema>>, DraftDocument<z.output<typeof schema>>, DraftFieldState<string>, DraftState<z.output<typeof schema>>, DuplicateOk<z.output<typeof schema>>, DuplicateOpts, ErrorCode, FindError, FindOk, HeadlessDebugLogApi<z.output<typeof schema>>, HeadlessDraftState<z.output<typeof schema>>, HeadlessJSONState<z.output<typeof schema>>, HeadlessRecorderApi<z.output<typeof schema>>, HeadlessSelectionState<z.output<typeof schema>>, HistoryStack<UndoEntry>, JSONChangeListener, JSONLoadOptions, JSONOps<z.output<typeof schema>>, JSONResult, JSONState<z.output<typeof schema>>, MoveError, MoveOk<z.output<typeof schema>>, MoveResult<z.output<typeof schema>>, PasteDuMismatch, PasteMode, PasteOk<z.output<typeof schema>>, PasteOptions, PointerOf<z.output<typeof schema>>, ReadFacade, RecordedStep, RecorderApi<z.output<typeof schema>>, Recording<z.output<typeof schema>>, RedoResult<z.output<typeof schema>, UndoEntry>, RekeyContext, RekeyOptions, RekeyStrategy, ReplaceCommandResult, ReplayDocumentTarget<z.output<typeof schema>>, ReplayOptions, ReplaySelectionTarget, ReplayTarget<z.output<typeof schema>>, SchemaState<z.output<typeof schema>>, SelectionAction, SelectionChangeListener, SelectionMode, SelectionRangeInput, SelectionSnap, SelectionState<z.output<typeof schema>>, SelectionType, UndoEntry, UndoNoop, UndoResult<z.output<typeof schema>, UndoEntry>, UseJSONOptions, UseSelectionOptions, ValueAt<z.output<typeof schema>, "/name">];',
      ...
      'const _createRecorderOptions = null as unknown as CreateRecorderOptions;',
      'const _createDebugLogOptions = null as unknown as CreateDebugLogOptions;',
      'const _createDraftOptions = null as unknown as CreateDraftOptions;',
      'const _createSelectionOptions = null as unknown as CreateSelectionOptions;',
      'const _headlessDebugLog = null as unknown as HeadlessDebugLogApi<z.output<typeof schema>>;',
      'const _headlessDraft = null as unknown as HeadlessDraftState<z.output<typeof schema>>;',
      'const _headlessRecorder = null as unknown as HeadlessRecorderApi<z.output<typeof schema>>;',
      'const _headlessSelection = null as unknown as HeadlessSelectionState<z.output<typeof schema>>;',
      ...
      'const _selectionListener = null as unknown as SelectionChangeListener;',
      'const _useSelectionOptions = null as unknown as UseSelectionOptions;',
      '_createDebugLogOptions.onChange?.() satisfies void;',
      '_createDraftOptions.onChange?.() satisfies void;',
      '_createRecorderOptions.onChange?.() satisfies void;',
      '_createSelectionOptions.onChange?.() satisfies void;',
      '_headlessDebugLog.dispose() satisfies void;',
      '_headlessDebugLog.events satisfies readonly DebugEvent[];',
      '_headlessDraft.dispose() satisfies void;',
      '_headlessDraft.field("/name").value satisfies unknown;',
      '_headlessRecorder.dispose() satisfies void;',
      '_headlessSelection.dispose() satisfies void;',
      '_recorder.steps satisfies readonly RecordedStep[];',
      '_selection.subscribe(_selectionListener) satisfies () => void;',
      '_selection.selectionRanges satisfies readonly import("zod-crud").SelectionRange[];',
      '_useSelectionOptions.mode satisfies SelectionMode | undefined;',
  ...
  await writeFile(
    ...
    [
      ...
      'import { EMPTY_HISTORY, createCan, createCheck, createClipboard, createCommands, createDebugLog, createDraft, createJSON, createRead, createRecorder, createSchema, createSelection, emptyHistory, historyBack, historyCanRedo, historyCanUndo, historyCommit, historyForward, historyMergeLast, useJSONDocument, useJSON, useSelection, useJSONSlice, useDraft, useField, useRecorder, replayRecording, useDebugLog } from "zod-crud/react";',
      ...
      'if (typeof createCan !== "function") throw new Error("createCan react export failed");',
      'if (typeof createCheck !== "function") throw new Error("createCheck react export failed");',
      'if (typeof createClipboard !== "function") throw new Error("createClipboard react export failed");',
      'if (typeof createCommands !== "function") throw new Error("createCommands react export failed");',
      'if (typeof createDebugLog !== "function") throw new Error("createDebugLog react export failed");',
      'if (typeof createDraft !== "function") throw new Error("createDraft react export failed");',
      'if (typeof createJSON !== "function") throw new Error("createJSON react export failed");',
      'if (typeof createRead !== "function") throw new Error("createRead react export failed");',
      'if (typeof createRecorder !== "function") throw new Error("createRecorder react export failed");',
      'if (typeof createSchema !== "function") throw new Error("createSchema react export failed");',
      'if (typeof createSelection !== "function") throw new Error("createSelection react export failed");',
      'if (EMPTY_HISTORY.undo.length !== 0) throw new Error("EMPTY_HISTORY react export failed");',
      'if (typeof emptyHistory !== "function") throw new Error("emptyHistory react export failed");',
      'if (typeof historyBack !== "function") throw new Error("historyBack react export failed");',
      'if (typeof historyCanRedo !== "function") throw new Error("historyCanRedo react export failed");',
      'if (typeof historyCanUndo !== "function") throw new Error("historyCanUndo react export failed");',
      'if (typeof historyCommit !== "function") throw new Error("historyCommit react export failed");',
      'if (typeof historyForward !== "function") throw new Error("historyForward react export failed");',
      'if (typeof historyMergeLast !== "function") throw new Error("historyMergeLast react export failed");',
  ...
  await writeFile(
    ...
    [
      'import * as z from "zod";',
      'import { JSONCrudError, createCan, createCheck, createClipboard, createCommands, createDebugLog, createDraft, createJSON, createRead, createRecorder, createSchema, createSelection, replayRecording, type Can, type ClipboardState, type CommandSelectionState, type Commands, type CreateCanOptions, type CreateCheckOptions, type CreateClipboardOptions, type CreateCommandsOptions, type CreateDebugLogOptions, type CreateDraftOptions, type CreateJSONOptions, type CreateReadOptions, type CreateRecorderOptions, type CreateSchemaOptions, type CreateSelectionOptions, type DebugEvent, type DebugLog, type DebugLogApi, type DebugLogger, type DraftChangeListener, type DraftDocument, type DraftFieldState, type DraftState, type HeadlessDebugLogApi, type HeadlessDraftState, type HeadlessJSONState, type HeadlessRecorderApi, type HeadlessSelectionState, type HistoryStack, type JSONDocument, type JSONOps, type JSONState, type ReadFacade, type RecordedStep, type RecorderApi, type Recording, type ReplaceCommandResult, type ReplayDocumentTarget, type ReplayOptions, type ReplaySelectionTarget, type ReplayTarget, type SchemaState, type SelectionChangeListener, type SelectionRangeInput, type SelectionState, type UseSelectionOptions, useDebugLog, useDraft, useField, useJSON, useJSONDocument, useJSONSlice, useRecorder, useSelection } from "zod-crud/react";',
      'const Schema = z.object({ name: z.string() });',
      ...
      'createCan satisfies (args: CreateCanOptions<typeof Schema>) => Can<z.output<typeof Schema>>;',
      'createCheck satisfies (args: CreateCheckOptions<typeof Schema>) => import("zod-crud").Check<z.output<typeof Schema>>;',
      'createClipboard satisfies (args: CreateClipboardOptions<typeof Schema>) => ClipboardState<z.output<typeof Schema>>;',
      'createCommands satisfies (args: CreateCommandsOptions<typeof Schema>) => Commands<z.output<typeof Schema>>;',
      'createDebugLog satisfies (ops: Ops) => HeadlessDebugLogApi<z.output<typeof Schema>>;',
      'createDraft satisfies (doc: DraftDocument<z.output<typeof Schema>>) => HeadlessDraftState<z.output<typeof Schema>>;',
      'createJSON satisfies (schema: typeof Schema, initial: z.output<typeof Schema>, options?: CreateJSONOptions) => HeadlessJSONState<z.output<typeof Schema>>;',
      'createRead satisfies (args: CreateReadOptions<typeof Schema>) => ReadFacade;',
      'createRecorder satisfies (ops: Ops) => HeadlessRecorderApi<z.output<typeof Schema>>;',
      'createSchema satisfies (args: CreateSchemaOptions<typeof Schema>) => SchemaState<z.output<typeof Schema>>;',
      'createSelection satisfies (ops: Ops) => HeadlessSelectionState<z.output<typeof Schema>>;',
      'useRecorder satisfies (ops: Ops) => RecorderApi<z.output<typeof Schema>>;',
      'replayRecording satisfies (recording: Recording<z.output<typeof Schema>>, target: ReplayTarget<z.output<typeof Schema>>, options?: ReplayOptions) => Promise<void>;',
      ...
      'const _selection = null as unknown as SelectionState<z.output<typeof Schema>>;',
      'const _commandSelection = null as unknown as CommandSelectionState;',
      'const _replaceCommandResult = null as unknown as ReplaceCommandResult;',
      'const _selectionListener = null as unknown as SelectionChangeListener;',
      'const _selectionRangeInput = null as unknown as SelectionRangeInput;',
      ...
      'const _replayDocumentTarget = null as unknown as ReplayDocumentTarget<z.output<typeof Schema>>;',
      'const _replayOptions = null as unknown as ReplayOptions;',
      'const _replaySelectionTarget = null as unknown as ReplaySelectionTarget;',
      'const _replayTarget = null as unknown as ReplayTarget<z.output<typeof Schema>>;',
      '_selection.ranges satisfies readonly string[];',
      '_commandSelection.selectionRanges satisfies readonly import("zod-crud").SelectionRange[];',
      '_replaceCommandResult.ok satisfies boolean;',
      '_selection.subscribe(_selectionListener) satisfies () => void;',
      '_selectionRangeInput satisfies string | { path: string } | { anchor: unknown; focus: unknown };',
      ...
      '_createDebugLogOptions.now?.() satisfies number | undefined;',
      '_createDraftOptions.onChange?.() satisfies void;',
      '_createRecorderOptions.now?.() satisfies number | undefined;',
      '_createSelectionOptions.onChange?.() satisfies void;',
      '_headlessDebugLog.events satisfies readonly DebugEvent[];',
      '_headlessDraft.subscribe(null as unknown as DraftChangeListener<z.output<typeof Schema>>) satisfies () => void;',
      '_headlessRecorder.dispose() satisfies void;',
      '_headlessSelection.dispose() satisfies void;',
      '_recordedStep.ops satisfies readonly import("zod-crud").JSONPatchOperation[];',
      '_recorder.steps satisfies readonly RecordedStep[];',
      '_recording.steps satisfies RecordedStep[];',
      '_replayDocumentTarget.ops satisfies Ops;',
      '_replayOptions.speed satisfies number | undefined;',
      '_replaySelectionTarget.restore satisfies (snapshot: import("zod-crud").SelectionSnap) => void;',
      '_replayTarget satisfies Ops | ReplayDocumentTarget<z.output<typeof Schema>>;',
